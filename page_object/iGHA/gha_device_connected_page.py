...
class GHADeviceConnectedPage(BasePage):
    ...
    def _get_done_btn(self) -> Optional[WebElement]:
        """Get the 'Add Devices' button using ACCESSIBILITY_ID."""
        return self._find_by_accessibility_id(constants.GHA_DONE_BTN_ACCESSIBILITY_ID)

    def click_done_btn(self) -> bool:
        """Ensure the 'Devices' tab is selected in GHA."""
        return self._get_done_btn().click()
