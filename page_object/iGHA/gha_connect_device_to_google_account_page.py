...
class GHAConnectDeviceToGoogleAccountPage(BasePage):
    ...
    def _get_i_agree_btn(self) -> Optional[WebElement]:
        """Get the 'Add Devices' button using ACCESSIBILITY_ID."""
        return self._find_by_class_chain(constants.GHA_I_AGREE_BTN_CLASS_CHAIN)

    def click_i_agree_btn(self) -> bool:
        """Ensure the 'Devices' tab is selected in GHA."""
        return self._get_i_agree_btn().click()
