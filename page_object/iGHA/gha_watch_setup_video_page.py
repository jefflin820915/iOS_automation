...
class GHAWatchSetupVideoPage(BasePage):
    ...
    def _get_next_btn(self) -> Optional[WebElement]:
        ...
        if BasePage.is_current_page(self) != "Watch setup video":
            self._logger.info("Not found Watch setup video page...")
        else:
    ...
    def handle_watch_setup_video_page_process(self):
